...
describe("Scope", function() {
  ...
  describe('$watchCollection', function() {
    ...
    // which you get from certain operations on
    // the DOM, such as querySelectorAll and getElementsByTagName
  ...
  });  // end of describe $watchCollection
  ...
  describe('Events', function() {
    ...
    it("does not propagate to parents when stopped on $emit", function() {
      var scopeListener = function(event) {
